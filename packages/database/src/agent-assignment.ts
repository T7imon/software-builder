...
export class PostgresAgentAssignmentRepository implements AgentAssignmentRepository {
  ...
  assignActiveAgent(capability:ProjectCapability,input:AssignActiveAgentInput):Promise<AgentAssignment>{return this.transaction(capability,"agent_assignment:append",async session=>{
